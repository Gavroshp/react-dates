  ...
  _createClass(MonthSelector, [{
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement('div', { className: 'MonthYearSwitch' }, _react2['default'].createElement('div', { className: 'Month' }, _react2['default'].createElement('button', { type: 'button', onClick: function () {
            function onClick() {
              return onSelectMonth(date, date.get('month') - 1);
            }

            return onClick;
          }() }, _react2['default'].createElement(_arrowLeft2['default'], null)), _react2['default'].createElement('button', { type: 'button', onClick: function () {
            function onClick() {
              return onSelectMonth(date, date.get('month') + 1);
            }

            return onClick;
          }() }, _react2['default'].createElement(_arrowRight2['default'], null)), _react2['default'].createElement('span', { className: 'Month--title' }, currentMonth)), _react2['default'].createElement('div', { className: 'Year' }, _react2['default'].createElement('button', { type: 'button', onClick: function () {
            function onClick() {
            ...
            return onClick;
          }() }, _react2['default'].createElement(_arrowRight2['default'], null)), _react2['default'].createElement('span', { className: 'Year--title' }, currentYear)));
      }
