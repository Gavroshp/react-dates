  ...
  _createClass(CalendarMonthGrid, [{
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        ...
        var hasMonthChanged = !this.state.initialMonth.isSame(initialMonth, 'month');
        ...
        if (hasMonthChanged && !hasNumberOfMonthsChanged) {
          ...
          if ((0, _isNextMonth2['default'])(this.state.initialMonth, initialMonth)) {
            newMonths = months.slice(1);
            newMonths.push(months[months.length - 1].clone().add(1, 'month'));
          } else {
            if ((0, _isPrevMonth2['default'])(this.state.initialMonth, initialMonth)) {
